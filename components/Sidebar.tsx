...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, darkMode, toggleDarkMode }) => {
  const navItems = [
    ...
    { id: 'calculator', label: 'AP Calc', icon: Calculator },
  ];

  return (
    <div className={`w-72 h-full flex flex-col border-r transition-all duration-500 ${darkMode ? 'bg-black border-zinc-800' : 'bg-white border-zinc-200 shadow-2xl'}`}>
